...
exports.default = _default;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"portfolio.js":[function(require,module,exports) {
"use strict";
...
var HOST_CARDS_URL = "http://localhost:3001/portfolio";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)(HOST_CARDS_URL).then(function (res) {
              return res.data.cards;
            });
          case 3:
            response_cards = _context.sent;
            console.log(response_cards);
            return _context.abrupt("return", response_cards);
          case 8:
            _context.prev = 8;
...
function renderMarkup() {
  return _renderMarkup.apply(this, arguments);
}
function _renderMarkup() {
  _renderMarkup = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var markup, render;
...
refs.portfolio.addEventListener("click", function (e) {
  e.preventDefault();
